...
public class R<T> {
    ...
    public R(ResultCode resultCode, boolean status, T data) {
    ...
    public R(ResultCode resultCode, boolean status) {
        this.code = resultCode.getCode();
        this.message = resultCode.getMessage();
        this.status = status;
        this.data = null;
    ...
    public static <T> R success() {
        return new R<>(ResultCodeImpl.OK, true);
    }

    public static <T> R message(String message) {
        return new R<>(ResultCodeImpl.OK.getCode(), message, true, null);
    }

    public static <T> R success(T data) {
        return new R<>(ResultCodeImpl.OK, true, data);
    }

    public static <T> R fail() {
        return new R<>(ResultCodeImpl.ERROR, false);
    }

    public static <T> R fail(ResultCode resultCode) {
    ...
    public static <T> R fail(ResultCode resultCode, T data) {
